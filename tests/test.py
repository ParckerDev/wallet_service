...
class WalletUser(HttpUser):
    ...
    wallet_uuid = "fa799d59-d053-4f33-84f8-042be5815c4b"
    ...
    def create_wallet(self):
        ...
        """
        response = self.client.get("/api/v1/wallets/new")  # Запрос на создание нового кошелька
    ...
    def deposit(self):
        ...
        """
        amount = random.uniform(1.0, 100.0)  # Генерируем случайную сумму для депозита
        self.client.post(f"/api/v1/wallets/{self.wallet_uuid}/operation", json={
    ...
    def withdraw(self):
        ...
        """
        amount = random.uniform(1.0, 100.0)  # Генерируем случайную сумму для вывода
        self.client.post(f"/api/v1/wallets/{self.wallet_uuid}/operation", json={
